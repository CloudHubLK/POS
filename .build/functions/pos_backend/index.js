...
app.get('/api/organizations', async (req, res) => {
  try {
    ...
    const booksService = new ZohoBooksService(catalystApp, getTenantConfig(req));
      ...
      res.send(`
        ...
        <body>
          ...
          <script>
            ...
            if (window.opener) {
              // Restrict postMessage to the actual opener origin to prevent token theft
              const targetOrigin = (document.referrer && document.referrer !== '')
